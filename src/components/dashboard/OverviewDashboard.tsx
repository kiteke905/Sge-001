...
export const OverviewDashboard: React.FC<OverviewDashboardProps> = ({ onNavigateTab }) => {
  ...
  const confirmedStudents = students.filter(s => s.status === 'CONFIRMADO').length;
  ...
  const allModules: AccessibleModule[] = [
    {
      ...
      stats: `${totalStudents} estudantes cadastrados`,
    ...
    },
    {
      ...
      stats: `${turmas.length} turmas ativas`,
    ...
    },
    {
      ...
      stats: `${totalTurmas} turmas distribuídas`,
      allowed: role === 'ADMIN' || role === 'GESTOR' || role === 'DIRECAO_PEDAGOGICA',
    },
    {
      id: 'horarios_provas',
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-white">
              Painel Inicial • Olá, {currentUser.name}
            </h1>
            ...
            <p className="text-xs sm:text-sm text-blue-200/90 max-w-2xl leading-relaxed">
              ...
              {currentUser.role === 'PROFESSOR' && 'Módulo Docente: lançamento de avaliações contínuas (MAC, NPP, NPT), minipautas e consulta a pautas gerais.'}
          ...
          <div className="flex items-center gap-3 self-start md:self-auto shrink-0">
            <div className="bg-white/10 backdrop-blur-xs border border-white/10 px-4 py-3 rounded-xl text-center min-w-[85px]">
              <span className="text-[10px] text-blue-200 uppercase font-bold block tracking-wider">Alunos</span>
              <span className="text-xl font-black text-white">{totalStudents}</span>
            </div>
            <div className="bg-white/10 backdrop-blur-xs border border-white/10 px-4 py-3 rounded-xl text-center min-w-[85px]">
              <span className="text-[10px] text-blue-200 uppercase font-bold block tracking-wider">Docentes</span>
              <span className="text-xl font-black text-white">{totalTeachers}</span>
            </div>
            <div className="bg-white/10 backdrop-blur-xs border border-white/10 px-4 py-3 rounded-xl text-center min-w-[85px]">
              <span className="text-[10px] text-blue-200 uppercase font-bold block tracking-wider">Turmas</span>
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-base sm:text-lg font-black text-slate-900 tracking-tight">
                Módulos & Serviços Autorizados para o seu Perfil
              </h2>
            </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="flex items-center justify-between text-xs text-slate-500 mt-2">
            <span>{confirmedStudents} Confirmados</span>
      ...
      {/* 2 Tables in Split View: Recent Students & Recent Receipts */}
